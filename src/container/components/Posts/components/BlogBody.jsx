...
const myPortableTextComponents = {
  block: {
    ...
    // h3: ({ children }) => <h3 className="mt-4 mb-2 font-semibold text-xl lg:text-2xl ">{children}</h3>,
    // h4: ({ children }) => <h4 className="mt-4 mb-2 font-semibold text-lg lg:text-xl ">{children}</h4>,
